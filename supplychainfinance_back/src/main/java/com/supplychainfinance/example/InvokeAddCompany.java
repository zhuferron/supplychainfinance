...
public class InvokeAddCompany {
    ...
    private static void doTransfer(String orgName, String userName, String companyName) throws IOException, ContractException, TimeoutException, InterruptedException {
        ...
        try (Gateway gateway = builder.connect()) {
            ...
            byte[] result = contract.submitTransaction("addCompany", RandomID.getUUID(), companyName, "yes", JSON.toJSONString(new ArrayList<>()), JSON.toJSONString(new ArrayList<>()));
    ...
    public static void main(String[] args) {
        try {
            doTransfer(ORGNAME_ORG1, USERNAME_ORG1,  "0001");
